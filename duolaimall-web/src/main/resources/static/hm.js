var hm = {
    ...
    default: {
        ...
        sendUrl: "https://csmall.goho.co/applog",
        // sendUrl: "http://csmalllog.viphk.ngrok.org/applog",
    ...
    util: {
        setCookie: function (name, value, time) {
            ...
            $.cookie(name, encodeURIComponent(value), {domain: 'csmall.com', expires: date, path: '/'})
        },
